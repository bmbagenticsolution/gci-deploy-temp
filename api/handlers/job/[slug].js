// api/job/[slug].js — Dynamic route for individual job pages
// Vercel: /api/job/[slug].js handles /api/job/senior-research-analyst-difc
// Rewrite: /careers/:slug → /api/job/:slug
...
module.exports = async function handler(req, res) {
  // Dynamic route: req.query.slug is populated by Vercel's [slug].js routing
  let slug = req.query.slug;
  // Fallback: parse from URL if query param missing
  if (!slug && req.url) {
    try {
